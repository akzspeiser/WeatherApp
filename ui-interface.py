...
"}")
        ...
        self.homeButton_2 = QtWidgets.QPushButton(self.frame_2)
        self.homeButton_2.setStyleSheet("background-color: #1f232a;")
        icon1 = QtGui.QIcon()
        ...
        self.verticalLayout_4.addWidget(self.homeButton_2)
